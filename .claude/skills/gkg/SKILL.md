---
name: tkm:gkg
description: Navigate large codebases semantically via GitLab Knowledge Graph — go-to-definition, find-usages, impact analysis, architecture maps. Use when grep falls short on complex multi-file relationships. Supports Ruby, Java, Kotlin, Python, TypeScript/JavaScript.
...
The craftsman who navigates by semantic understanding moves with purpose — they do not search blindly through the workshop, they go directly to what they seek. Symbol by symbol, reference by reference, the structure of the codebase becomes legible as a map rather than a labyrinth.
