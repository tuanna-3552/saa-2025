...
2. If no logo provided: generate with `sk:ai-multimodal` skill
3. Screenshot wireframes with `sk:chrome-devtools` → save to `./docs/wireframes/`
...
Activate **sk:plan** skill: `/tkm:create-plan --fast <requirements>`
