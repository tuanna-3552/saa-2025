...
3. If no logo provided: generate with `sk:ai-multimodal` skill
4. Screenshot wireframes with `sk:chrome-devtools` → save to `./docs/wireframes/`
...
Activate **sk:plan** skill: `/tkm:create-plan --auto <requirements>`
...
Activate **tkm:takumi** skill: `/tkm:takumi --auto <plan-path>`
