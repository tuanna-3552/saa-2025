...
A cluttered workbench slows every task. The craftsman who cannot find the right tool wastes time before a single cut is made.
Context is the AI's workbench. Every irrelevant token is a tool left in the wrong place.
The craftsman who arranges the workshop curates the smallest high-signal token set — so reasoning begins at the material, not at the pile.
