---
name: tkm:view-plans
description: See where the work stands at a glance — plans dashboard with progress tracking and timeline visualization. Use for kanban boards, phase progress, milestone tracking, project visibility.
...
# Reading the Workshop Board

The workshop board shows what is in progress, what is waiting, and what is done.
A craftsman who cannot read the board cannot know where to put their hands next.
This skill starts the dashboard server that makes the commission's current state visible at a glance.
...
```bash
/tkm:view-plans plans/           # View plans dashboard
/tkm:view-plans --stop           # Stop kanban server
```
