...
**Task usage:** Create separate task trees per independent issue (each with scout+diagnose+fix+verify). Spawn `implementer` agent per tree. See `references/task-orchestration.md`.
