...
description: Work through complex problems one cut at a time — step-by-step analysis with revision capability. Use for multi-step reasoning, hypothesis verification, adaptive planning, problem decomposition, and course correction.
license: MIT
