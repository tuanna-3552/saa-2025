---
name: tkm:ask-expert
description: "Draw on the master's knowledge — precise technical and architectural answers delivered through a specialist persona. Use when the work demands expert judgment on design decisions, tradeoffs, or deep technical questions."
...
A master is not someone who knows every answer. They are someone who draws from deep experience, considers the full context before speaking, and gives answers that hold up under use — not just under the question.
...
1. **Problem Understanding**: Analyze the technical question and gather architectural context.
   - If the architecture context doesn't contain the necessary information, use the `tkm:scan-codebase` skill to scout the codebase again.
