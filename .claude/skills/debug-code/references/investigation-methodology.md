...
- Otherwise use `sk:repomix` to generate fresh codebase summary
- Use `/tkm:scan-codebase` or `/tkm:scan-codebase ext` to find relevant files
- Use `sk:docs-seeker` skill for package/plugin documentation
