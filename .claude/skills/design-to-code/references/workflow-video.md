...
## Prerequisites
- Activate `sk:ui-ux-pro-max` skill first
- Have `sk:ai-multimodal` skill ready for video analysis

## Workflow Steps

### 1. Analyze Video Details
Use `sk:ai-multimodal` skill to describe:
...
- Use `sk:media-processing` for processing
