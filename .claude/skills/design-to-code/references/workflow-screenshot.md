...
## Prerequisites
- Activate `sk:ui-ux-pro-max` skill first for design intelligence
- Have `sk:ai-multimodal` skill ready for visual analysis

## Workflow Steps

### 1. Analyze Screenshot Details
Use `sk:ai-multimodal` skill to extract:
...
### 4. Generate Assets
Use `sk:ai-multimodal` skill:
- Generate images, icons, backgrounds
- Verify generated assets match design
- Remove backgrounds if needed with `sk:media-processing`
