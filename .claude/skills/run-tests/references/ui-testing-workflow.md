...
Activate the sk:chrome-devtools skill.
...
## Workflow
- Use `sk:plan` skill to organize the test plan & report
...
- Use `sk:ai-multimodal` to analyze all screenshots
- Generate comprehensive Markdown report
- Ask user if they want to preview with `/tkm:preview-output`
