---
name: tkm:devops
description: Set up and operate production infrastructure. Activate when the user needs Docker/Kubernetes, Cloudflare Workers/R2/D1, GCP Cloud Run, CI/CD pipeline setup, GitOps workflows, or Helm charts — when the work needs infrastructure, not just code.
license: MIT
