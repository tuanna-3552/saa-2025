...
For presentation-grade output, consider invoking `/tkm:design-ui` for richer style selection and distinctive font/palette pairing.
...
**AI image generation:** If `/tkm:analyze-media` skill is available, use it to generate images for the deck. For any deck over 10 slides, target a minimum of 2–4 images. Priority order:
...
```bash
# Use /tkm:analyze-media skill for image generation if needed
