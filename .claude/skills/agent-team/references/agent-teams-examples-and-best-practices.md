...
For any template where teammates edit code (takumi, fix), always use `isolation: "worktree"`:
...
| Takumi (4 teammates) | ~400K-800K | Highest -- code generation |
