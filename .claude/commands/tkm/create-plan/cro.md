...
7. Cognitive Bias Stask: Loss aversion (fear), social proof (FOMO), anchoring (pricing)
...
24. Performance Tracking Stask: Heatmaps show problems, recordings show why, events show what
