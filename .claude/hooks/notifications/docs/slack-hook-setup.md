...
```env
SLASK_WEBHOOK_URL=https://hooks.slack.com/services/xxx/yyy/zzz
```
...
| No notification | Verify SLASK_WEBHOOK_URL is set correctly |
...
**Required Environment Variable:** `SLASK_WEBHOOK_URL`
