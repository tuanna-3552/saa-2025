...
describe('loadPatterns', () => {
  it('loads patterns from fixture file', () => {
    const patterns = loadPatterns(path.join(FIXTURES_DIR, 'skignore-default.txt'));
  ...
  it('returns DEFAULT_PATTERNS for non-existent file', () => {
    const patterns = loadPatterns('/non/existent/.skignore');
  ...
  it('loads custom patterns', () => {
    const patterns = loadPatterns(path.join(FIXTURES_DIR, 'skignore-custom.txt'));
  ...
  it('loads negation patterns', () => {
    const patterns = loadPatterns(path.join(FIXTURES_DIR, 'skignore-negation.txt'));
  ...
  it('merges project override patterns after shipped patterns', () => {
    const patterns = loadPatterns(
      path.join(FIXTURES_DIR, 'skignore-default.txt'),
      path.join(FIXTURES_DIR, 'skignore-project-override.txt')
    );
  ...
  it('ignores missing project override files', () => {
    const patterns = loadPatterns(
      path.join(FIXTURES_DIR, 'skignore-default.txt'),
      '/non/existent/project/.skignore'
    );
    const shipped = loadPatterns(path.join(FIXTURES_DIR, 'skignore-default.txt'));
...
describe('matchPath - custom .skignore', () => {
  const patterns = loadPatterns(path.join(FIXTURES_DIR, 'skignore-custom.txt'));
  const matcher = createMatcher(patterns);
