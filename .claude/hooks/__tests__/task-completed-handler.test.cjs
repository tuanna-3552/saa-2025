...
describe('task-completed-handler.cjs', () => {
  ...
  describe('Completion logging', () => {
    ...
    it('logs completion to report file when SK_REPORTS_PATH set', async () => {
      ...
      try {
        ...
        }, { env: { HOME: tmpDir, SK_REPORTS_PATH: reportsDir } });
    ...
    it('does not crash when SK_REPORTS_PATH is unset', async () => {
      ...
      try {
        ...
        }, { env: { HOME: tmpDir, SK_REPORTS_PATH: '' } });
