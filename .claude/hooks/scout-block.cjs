 ...
 *
 * Blocks access to directories listed in the shipped .claude/.skignore baseline
 * plus an optional project-local .claude/.skignore override at the git root.
 ...
 *
 * Configuration:
 * - Edit .claude/.skignore to customize shipped baseline patterns
 * - Add <project-root>/.claude/.skignore to override locally without changing the baseline
