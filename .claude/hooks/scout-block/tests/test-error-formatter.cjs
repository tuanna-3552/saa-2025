...
test('formatConfigPath with claudeDir', formatConfigPath('/home/user/.claude').includes('.skignore'));
test('formatConfigPath prefers explicit configPath', formatConfigPath('/home/user/.claude', '/tmp/project/.skignore') === '/tmp/project/.skignore');
test('formatConfigPath without claudeDir', formatConfigPath(null) === '.claude/.skignore');
test('formatConfigPath empty string', formatConfigPath('') === '.claude/.skignore');
...
const blockError = formatBlockedError({
  ...
  configPath: '/home/user/project/.skignore'
});
...
test('formatBlockedError prefers explicit config path', blockError.includes('/home/user/project/.skignore'));
...
const machineError = formatMachineError({
  ...
  tool: 'Read',
  claudeDir: '.claude',
  configPath: '/tmp/project/.skignore'
});
...
test('formatMachineError has config field', parsed.config === '/tmp/project/.skignore');
