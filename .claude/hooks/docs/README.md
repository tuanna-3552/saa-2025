...
| **Slack** | `SLASK_WEBHOOK_URL` | [slack-hook-setup.md](../notifications/docs/slack-hook-setup.md) |
...
SLASK_WEBHOOK_URL=https://hooks.slack.com/services/...
```
...
**Blocked Patterns** (baseline in `.claude/.skignore`, optional override in `<project-root>/.claude/.skignore`):
...
- Check throttle state: `cat /tmp/sk-noti-throttle.json`
- Test manually with echo pipe above

**Provider throttled:**
- Wait 5 minutes or delete `/tmp/sk-noti-throttle.json`
